...
rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u1)
alply(rez, c(1,2))

rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u2)
alply(rez, c(1,2))

rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u3)
alply(rez, c(1,2))

rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u4)
alply(rez, c(1,2))

rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u5)
alply(rez, c(1,2))

rez <- dM(Phi, Psi, Gam, H, Q, R, X_0, P0, th, u6)
alply(rez, c(1,2))
@
